...
function RouteDetailsLoadingState() {
  return (
  ...
  return (
    <View className="flex-1 items-center justify-center gap-5 bg-background px-6">
      <View className="h-14 w-14 items-center justify-center rounded-lg border border-border bg-card">
        <Icon as={RouteIcon} size={24} className="text-muted-foreground" strokeWidth={2.3} />
      </View>
      <View className="gap-2">
        ...
        <Text className="text-center text-[14px] leading-6 text-muted-foreground">
          Ta trasa mogła zniknąć z rotacji albo link jest nieaktualny.
        </Text>
      </View>
...
export { RouteDetailsLoadingState, RouteNotFoundState };
